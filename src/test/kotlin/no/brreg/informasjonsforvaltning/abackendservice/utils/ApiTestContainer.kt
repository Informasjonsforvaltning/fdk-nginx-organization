...
abstract class ApiTestContainer {
    ...
    companion object {
        ...
        init {
            ...
            populateDB()
            TEST_API = KGenericContainer(System.getProperty("testImageName") ?: "eu.gcr.io/fdk-infra/a-backend-service:latest")
            ...
            try {
                val result = TEST_API.execInContainer("wget", "-O", "-", "http://host.testcontainers.internal:5000/auth/realms/fdk/protocol/openid-connect/certs")
        ...
        fun stopGracefully() {
            ...
            TEST_API.dockerClient
                .stopContainerCmd(TEST_API.getContainerId())
                .withTimeout(100)
                .exec()
        }
    }
